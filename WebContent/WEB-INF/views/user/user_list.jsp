   		...
   		<form id="addForm" method="post">
	    	<table id="addTable" cellpadding="8" >
	    		<tr>
	    			<td>用户名:</td>
	    			<td>
	    				<input id="add_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, validType:'repeat', missingMessage:'请填写用户名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
    	...
    	<form id="editForm" method="post">
	    	...
	    	<table id="editTable" border=0  cellpadding="8" >
	    		<tr>
	    			<td>用户名:</td>
	    			<td>
	    				<input id="edit_username"  class="easyui-textbox" style="width: 200px; height: 30px;" type="text" name="username" data-options="required:true, validType:'repeat', missingMessage:'请填写用户名'" />
	    			</td>
	    		</tr>
	    		<tr>
	    			<td>密码:</td>
