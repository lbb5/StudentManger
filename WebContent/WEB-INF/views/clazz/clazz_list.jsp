	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果班级下存在班级信息，需要删除班级信息？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			所属年级：<select id="search-grade-id" class="easyui-combobox" style="width: 130px;">
						<option value="">全部</option>
						<!-- gradeList -->
						<c:forEach items="${gradeListJson}" var="grade">
