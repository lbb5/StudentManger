...
<head>
	...
	$(function() {	
	    ...
	    $("#delete").click(function(){
        	...
        	if(selectLength == 0){
            	...
            	$.messager.confirm("消息提醒", "如果学生下存在学生信息，需要删除学生信息？", function(r){
            		if(r){
            			$.ajax({
							type: "post",
							url: "delete",
	  ...
	  /*   editPhotoForm */
	  	...
	  	$("#editDialog").dialog({
			...
			onBeforeOpen: function(){
				...
				$("#edit_password").combobox('setValue', selectRow.password);
	...
	function uploaded(e) {
		...
		if(data.type=="success"){
			 $.messager.alert("消息提醒","图片上传成功","warning");
...
<body>
	...
	<div id="toolbar">
		...
		<div>
			...
			所属班级：<select id="search-clazz-id" class="easyui-combobox" style="width: 130px;">
			...
			<a id="search-btn" href="javascript:;" class="easyui-linkbutton" data-options="iconCls:'icon-search',plain:true">搜索</a></div>
		...
		<form id="photoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
   		...
   		<form id="addForm" method="post">
	    	<table id="addTable2" cellpadding="8" >
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td><input id="add_remark" style="width: 256px; height: 170px;" class="easyui-textbox" type="text" name="remark" data-options="multiline:true"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
    	...
    	<form id="editPhotoForm" method="post" enctype="multipart/form-data" action="upload_photo" target="photo_target">
   		...
   		<input  type="hidden" name="id" id="edit-id" />
	    	<table id="editTable2" cellpadding="8" >
	    		...
	    		<tr>
	    			<td>备注:</td>
	    			<td><input id="edit_remark" style="width: 256px; height: 170px;" class="easyui-textbox" type="text" name="remark" data-options="multiline:true"  /></td>
	    		</tr>
	    	</table>
	    </form>
	</div>
